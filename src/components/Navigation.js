      ...
      <Navbar bg="dark" variant="dark" expand="lg" className="py-3">
        <Container>
          ...
          <Nav className="mx-auto">
            <Nav.Link as={Link} to="/" className="text-white mx-3 d-flex align-items-center white-space-nowrap">Home</Nav.Link>
            <Nav.Link as={Link} to="/donate" className="text-white mx-3 d-flex align-items-center white-space-nowrap">Donate & Mint</Nav.Link>
            <Nav.Link as={Link} to="/gallery" className="text-white mx-3 d-flex align-items-center white-space-nowrap">Gallery</Nav.Link>
            <Nav.Link as={Link} to="/my-nfts" className="text-white mx-3 d-flex align-items-center white-space-nowrap">View My NFTs</Nav.Link>
            <Nav.Link as={Link} to="/about" className="text-white mx-3 d-flex align-items-center white-space-nowrap">About</Nav.Link>
            <Nav.Link as={Link} to="/admin" className="text-white mx-3 d-flex align-items-center white-space-nowrap">Admin</Nav.Link>
          </Nav>
